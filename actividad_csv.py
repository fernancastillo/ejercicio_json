...
import csv
os.system("cls")
with open("listadoRutEmpresa.csv",'w',newline="") as archivo:
    escritor_csv = csv.writer(archivo)
    escritor_csv.writerow(["rut","nombre","empresa"])
    escritor_csv.writerows([["72642413-6","Comercial Calcetas Runner",150000000],
